package com.santos.herald.appsolutelytakehome.platform.extensions
...
fun <T> getDisposableObserver(onNext: (T) -> Unit, onError: (Throwable) -> Unit = {}): DisposableObserver<T> {
